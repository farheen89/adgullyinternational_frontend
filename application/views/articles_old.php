               ...
               <div class="column column-3"  id="test_div">
                  ...
                  foreach ( $lists as $column) {// print_r($column); die; 
                     ?>
  ...
  <input type="text" name="load_more" value="0" class="load_more">
                    <div id="ajax_table">

                     </div>
                  <div id="load_more_data" style="display: none;">
